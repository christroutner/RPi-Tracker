  ...
  this.filesToSend = function() {
    ...
    //The server is more than a day behind and needs any intermediate daily log files.
      ...
      if(globalThis.logFileCnt < numDays) {
        ...
        var curLogFile = globalThis.Date2DayStamp(new Date(global.gpsInterface.timeStamp.getTime()+globalThis.logFileCnt*msPerDay));
