  ...
  this.readNMEASentences = function(data) {
    ...
    switch(nmeaCode) {
      ...
      case "GPGGA":
        ...
        var lat = this.ConvertDMSToDD(Number(data.slice(14,16)),Number(data.slice(16,23)),0,data.slice(24,25));
        var long = this.ConvertDMSToDD(Number(data.slice(26,29)), Number(data.slice(29,36)), 0, data.slice(37,38));
