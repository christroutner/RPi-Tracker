...
function Constructor() {
  ...
  this.timeoutSetting = 60000;
  this.timeout = 60000; //Number of milliseconds between attempts to upload data to the server.
  this.intervalHandle = undefined;
  
  //Tracker server
  //this.trackerServerIp = '198.199.94.71';
  //this.trackerServerPort = '3000';
  this.trackerServerIp = '192.168.1.2';
  this.trackerServerPort = '3000';
...
//GENERATE AN ARRAY OF FILE NAMES TO BE SENT TO SERVER
  ...
  this.findNextFile = function() {
    ...
    if(globalThis.logFileCnt < numDays) {
      ...
      var curLogFile = globalThis.Date2DayStamp(new Date(globalThis.lastServerDate.getTime()+(globalThis.logFileCnt+1)*msPerDay));
