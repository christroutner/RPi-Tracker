...
function Constructor() {
  ...
  this.syncWithServer = function() {
    ...
    if(global.debugState) {
      ...
      globalThis.syncLog.push('Server\'s last log file: '+globalThis.lastServerDate+', Day stamp: '+serverDayStamp);
      globalThis.syncLog.push('Client\'s time: '+global.gpsInterface.timeStamp+', Day stamp: '+clientDayStamp);
    }
