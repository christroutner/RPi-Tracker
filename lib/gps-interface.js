...
function Constructor() {
  ...
  //This are used if 'dummy' Lat or Long values need to be used by the system.
  this.lastLat = 0;
  this.lastLong = 0;
  ...
  this.readNMEASentences = function(data) {
    ...
    switch(nmeaCode) {
      case "GPZDA":
        ...
        globalThis.timeStamp = new Date(year, month, day, hour, minute, second, millisecond);
      ...
      case "GPGGA":
        ...
        //Update the global last Lat and Long
        globalThis.lastLat = lat;
        globalThis.lastLong = long;
        ...
        //Temp code used for getting to the bottom of the startup logging bug.
        //if(global.debugState) {
        //  if(global.dataLog.extendedDebug)
