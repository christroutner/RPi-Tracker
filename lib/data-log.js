    ...
    fs.readFile('./data/'+fileName, 'utf8', function(err, data) {
      if (err) {
        ...
        if( err.code == "ENOENT" ) {    
          ...
          app.locals.jsonPointTimeStamp.data = 
          {
          ...
          app.locals.jsonPointTimeStamp.fileRead = true;
        ...
        app.locals.jsonPointTimeStamp.data = JSON.parse(data);
        app.locals.jsonPointTimeStamp.fileRead = true;
        app.locals.jsonPointTimeStamp.exists = true;
      }
    });
  }
