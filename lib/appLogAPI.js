  ...
  ******************************************************************************/
  this.getLog = function(request, response, next) {
    ...
    exec('tail --lines=50 ~/.pm2/logs/rpi-tracker-out-0.log', function(err, stdout, stderr) {
      ...
      console.error('Catastrophic error in appLogAPI.js/getLog(). Error: ', err);
    }
  };
  ...
  this.clearLog = function() {
    ...
    try {
      ...
      console.error('Catastrophic error in appLogAPI.js/clearLog(). Error: ', err);
    }
  };
  ...
  this.backupLog = function() {
    ...
    try {
      ...
      console.error('Catastrophic error in appLogAPI.js/backupLog(). Error: ', err);
    }
  };
